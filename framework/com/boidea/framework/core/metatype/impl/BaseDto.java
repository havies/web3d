package com.boidea.framework.core.metatype.impl;
...
import com.boidea.framework.core.xml.XmlHelper;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	...
	public String toXml(String pStyle) {
		String strXml = null;
		if (pStyle.equals(BFConstants.XML_Attribute))
			// 节点属性值风格
			strXml = XmlHelper.parseDto2Xml(this, "root", "row");
		else if (pStyle.equals(BFConstants.XML_Node))
			// 节点元素值风格
