...
import com.boidea.framework.core.resource.util.ResourceWebUtils;
...
public abstract class AbstractResourceServlet extends HttpServlet {
	...
	private void handle(HttpServletRequest pRequest, HttpServletResponse pResponse) throws ServletException,
		...
		pResponse.setHeader("ETag", "BF" + Long.toString(res.getLastModified()));
		pResponse.setHeader("power-by", "BF");
	...
	public void init(ServletConfig pServletConfig) throws ServletException {
		...
		logger.info("正在创建BF.Resource静态资源管理器...");
		resourceManager = createResourceManager(pServletConfig);
		resourceManager.init();
		logger.info("创建BF.Resource静态资源管理器成功.");
	}
