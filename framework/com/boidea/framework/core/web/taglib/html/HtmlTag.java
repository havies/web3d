...
public class HtmlTag extends TagSupport{
	...
	public int doStartTag() throws JspException{
		...
		dto.put("extDisabled", BFUtils.isEmpty(extDisabled) ? "false" : extDisabled);
		dto.put("title", BFUtils.isEmpty(title) ? "BoideaFramework" : title);
		dto.put("jqueryEnabled", BFUtils.isEmpty(jqueryEnabled) ? "false" : jqueryEnabled);
		dto.put("showLoading", BFUtils.isEmpty(showLoading) ? "true" : showLoading);
