...
<link rel="stylesheet" type="text/css" href="${contextPath}/resource/theme/gray/resources/css/ext-all.css"/>
...
<link rel="stylesheet" type="text/css" href="${contextPath}/resource/css/framework.css"/>
		...
		if (response.status == ajaxErrCode) {
			setTimeout(function(){
				...
				top.Ext.MessageBox.alert('提示', '由于长时间未操作,空闲会话已超时;您将被强制重定向到登录页面!', function() {
					top.location.href = webContext + '/login.do?reqCode=init';
				});
			},200);
...
var deptid = '${userInfo.getDeptid()}';var customId = '${userInfo.getCustomId().trim()}';var theme = 'gray';
