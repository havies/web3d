package com.boidea.framework.core.mvc.xstruts.config.impl;
...
import com.boidea.framework.core.mvc.xstruts.config.ActionConfigMatcher;
import com.boidea.framework.core.mvc.xstruts.config.BaseConfig;
import com.boidea.framework.core.mvc.xstruts.config.ControllerConfig;
...
public class ModuleConfigImpl extends BaseConfig implements Serializable, ModuleConfig {
	 ...
	 * </p>
	 */
	protected String actionFormBeanClass = "com.boidea.framework.core.mvc.xstruts.action.ActionFormBean";

	/**
	 * The default class name to be used when creating action mapping instances.
	 */
	protected String actionMappingClass = "com.boidea.framework.core.mvc.xstruts.action.ActionMapping";

	/**
	 * The default class name to be used when creating action forward instances.
	 */
	protected String actionForwardClass = "com.boidea.framework.core.mvc.xstruts.action.ActionForward";
	...
	public ModuleConfigImpl(String prefix) {
		...
		this.actionFormBeanClass = "com.boidea.framework.core.mvc.xstruts.action.ActionFormBean";
		this.actionMappingClass = "com.boidea.framework.core.mvc.xstruts.action.ActionMapping";
		this.actionForwardClass = "com.boidea.framework.core.mvc.xstruts.action.ActionForward";
