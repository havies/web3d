package com.boidea.framework.core.mvc.xstruts;
...
public class Globals implements Serializable {
	 ...
	 * @since Struts 1.1
	 */
	public static final String ACTION_SERVLET_KEY = "com.boidea.framework.core.mvc.xstruts.action.ACTION_SERVLET";
	 ...
	 * @since Struts 1.1
	 */
	public static final String CANCEL_KEY = "com.boidea.framework.core.mvc.xstruts.action.CANCEL";
	 ...
	 * @since Struts 1.1
	 */
	public static final String MODULE_KEY = "com.boidea.framework.core.mvc.xstruts.action.MODULE";
	 ...
	 * @since Struts 1.2
	 */
	public static final String MODULE_PREFIXES_KEY = "com.boidea.framework.core.mvc.xstruts.globals.MODULE_PREFIXES";
	 ...
	 * @since Struts 1.3
	 */
	public static final String ORIGINAL_URI_KEY = "com.boidea.framework.core.mvc.xstruts.globals.ORIGINAL_URI_KEY";

	/**
	 * The request attributes key under which your action should store an
	 * <code>com.boidea.framework.core.mvc.xstruts.action.ActionErrors</code> object, if
	 * you are using the corresponding custom tag library elements.
	 */
	public static final String ERROR_KEY = "com.boidea.framework.core.mvc.xstruts.action.ERROR";
	 ...
	 */
	public static final String EXCEPTION_KEY = "com.boidea.framework.core.mvc.xstruts.action.EXCEPTION";
	 ...
	 */
	public static final String LOCALE_KEY = "com.boidea.framework.core.mvc.xstruts.action.LOCALE";

	/**
	 * The request attributes key under which our
	 * <code>com.boidea.framework.core.mvc.xstruts.ActionMapping</code> instance is
	 * passed.
	 */
	public static final String MAPPING_KEY = "com.boidea.framework.core.mvc.xstruts.action.mapping.instance";

	/**
	 * The request attributes key under which your action should store an
	 * <code>com.boidea.framework.core.mvc.xstruts.action.ActionMessages</code> object,
	 * if you are using the corresponding custom tag library elements.
	 * 
	 * @since Struts 1.1
	 */
	public static final String MESSAGE_KEY = "com.boidea.framework.core.mvc.xstruts.action.ACTION_MESSAGE";
	 ...
	 * </p>
	 */
	public static final String MESSAGES_KEY = "com.boidea.framework.core.mvc.xstruts.action.MESSAGE";

	/**
	 * The request attributes key under which our multipart class is stored.
	 */
	public static final String MULTIPART_KEY = "com.boidea.framework.core.mvc.xstruts.action.mapping.multipartclass";
	 ...
	 * @since Struts 1.1
	 */
	public static final String PLUG_INS_KEY = "com.boidea.framework.core.mvc.xstruts.action.PLUG_INS";
	 ...
	 * @since Struts 1.1
	 */
	public static final String REQUEST_PROCESSOR_KEY = "com.boidea.framework.core.mvc.xstruts.action.REQUEST_PROCESSOR";
	 ...
	 * ).
	 */
	public static final String SERVLET_KEY = "com.boidea.framework.core.mvc.xstruts.action.SERVLET_MAPPING";

	/**
	 * The session attributes key under which our transaction token is stored,
	 * if it is used.
	 */
	public static final String TRANSACTION_TOKEN_KEY = "com.boidea.framework.core.mvc.xstruts.action.TOKEN";
	 ...
	 * @since Struts 1.1
	 */
	public static final String XHTML_KEY = "com.boidea.framework.core.mvc.xstruts.globals.XHTML";

	/**
	 * The name of the taglib package.
	 */
	public static final String TAGLIB_PACKAGE = "com.boidea.framework.core.mvc.xstruts.taglib.html";
