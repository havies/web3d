...
Ext.calendar.EventEditForm = Ext.extend(Ext.form.FormPanel, {
    ...
    loadRecord: function(rec) {
        ...
        this.reminderField.setValue(rec.data.Reminder);//added by zhaozh
        if (this.calendarStore) {
            this.form.setValues({
    ...
    updateRecord: function() {
        ...
        this.activeRecord.set(Ext.calendar.EventMappings.Reminder.name, this.reminderField.getValue());//added by zhaozh
    },
