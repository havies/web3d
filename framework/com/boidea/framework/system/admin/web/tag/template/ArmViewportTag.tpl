...
<div id="previewDiv" class="x-hidden"  >
	<img src="${contextPath}/resource/image/theme/gray.jpg" />
</div>
...
Ext.onReady(function(){
            mainTabs = new Ext.TabPanel({
                ...
                items:[{
                      ...
                      html:"<iframe id='welcomePage_ifrm' src='index.do?reqCode=preferencesInit' scrolling='auto' frameborder='0' width='100%' height='100%' ></iframe>"
                    }]
             });
...
function addTab(url,name,menuid,pathCh,icon){
  ...
  if (!n) {
     ...
     n = mainTabs.add({
       ...
       html:'<iframe id="tab_id_'+menuid+'_ifrm" scrolling="auto" frameborder="0" width="100%" height="100%" src="'+url+'"></iframe>'
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"  
	height="60" background="./resource/image/banner_background/gray.png">
	<tr >
...
<tr>
<td width="65%"><nobr>&nbsp;<img class="IEPNG" src="./resource/image/ext/comments2.png" />&nbsp;${welcome},${username}! <!--今天是:${date} ${week} <span id="rTime"><span>&nbsp;帐户:${account}(${rolespecName})&nbsp;所属部门:${deptname}--></nobr></td>
