...
public class IDHelper {
	 ...
	 * ROLEID
	 */
	private static DefaultIDGenerator defaultIDGenerator_ruleid = null;
	
	/**
	 * ROLEID
	 */
	private static DefaultIDGenerator defaultIDGenerator_ruleroleid = null;
	
	/**
	 * ROLEID
	 */
	private static DefaultIDGenerator defaultIDGenerator_ruleuserid = null;
	...
	static {
		IdGenerator idGenerator_ruleid = new IdGenerator();
		idGenerator_ruleid.setFieldname("RULEID");
		defaultIDGenerator_ruleid = idGenerator_ruleid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_ruleroleid = new IdGenerator();
		idGenerator_ruleroleid.setFieldname("RULEROLEID");
		defaultIDGenerator_ruleroleid = idGenerator_ruleroleid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_ruleuserid = new IdGenerator();
		idGenerator_ruleuserid.setFieldname("RULEUSERID");
		defaultIDGenerator_ruleuserid = idGenerator_ruleuserid.getDefaultIDGenerator();
	}
...
//	}
	...
	public static String getRuleID() {
		return defaultIDGenerator_ruleid.create();
	}
	 ...
	 * @return
	 */
	public static String getRuleRoleID() {
		return defaultIDGenerator_ruleroleid.create();
	}
	 ...
	 * @return
	 */
	public static String getRuleUserID() {
		return defaultIDGenerator_ruleuserid.create();
	}
