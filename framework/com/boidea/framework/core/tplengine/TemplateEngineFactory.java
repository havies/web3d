package com.boidea.framework.core.tplengine;

import java.util.HashMap;
import java.util.Map;

import com.boidea.framework.core.tplengine.velocity.VelocityTemplateEngine;
...
public class TemplateEngineFactory {
	...
	public static TemplateEngine getTemplateEngine(TemplateType pType) {
		...
		if (ENGINES.containsKey(pType) == false) {
			throw new IllegalArgumentException(BFConstants.Exception_Head + "不支持的模板类别:" + pType.getType());
		}
