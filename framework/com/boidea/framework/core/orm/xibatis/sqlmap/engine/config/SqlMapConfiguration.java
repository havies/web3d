package com.boidea.framework.core.orm.xibatis.sqlmap.engine.config;

import java.util.Iterator;

import com.boidea.framework.core.orm.xibatis.common.beans.ClassInfo;
import com.boidea.framework.core.orm.xibatis.common.beans.Probe;
import com.boidea.framework.core.orm.xibatis.common.beans.ProbeFactory;
import com.boidea.framework.core.orm.xibatis.common.resources.Resources;
import com.boidea.framework.core.orm.xibatis.sqlmap.client.SqlMapException;
import com.boidea.framework.core.orm.xibatis.sqlmap.client.extensions.TypeHandlerCallback;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.accessplan.AccessPlanFactory;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.cache.CacheController;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.cache.CacheModel;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.cache.fifo.FifoCacheController;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.cache.lru.LruCacheController;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.cache.memory.MemoryCacheController;
//import com.boidea.framework.core.orm.xibatis.sqlmap.engine.datasource.DbcpDataSourceFactory;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.datasource.JndiDataSourceFactory;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.datasource.SimpleDataSourceFactory;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.impl.SqlMapClientImpl;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.impl.SqlMapExecutorDelegate;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.mapping.result.Discriminator;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.mapping.result.ResultMap;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.mapping.result.ResultObjectFactory;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.mapping.statement.MappedStatement;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.scope.ErrorContext;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.transaction.TransactionManager;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.transaction.external.ExternalTransactionConfig;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.transaction.jdbc.JdbcTransactionConfig;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.transaction.jta.JtaTransactionConfig;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.type.CustomTypeHandler;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.type.DomCollectionTypeMarker;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.type.DomTypeMarker;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.type.TypeHandler;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.type.TypeHandlerFactory;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.type.XmlCollectionTypeMarker;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.type.XmlTypeMarker;
...
//		typeHandlerFactory.putTypeAlias("DBCP", DbcpDataSourceFactory.class.getName());
		...
		// upon init
		typeHandlerFactory.putTypeAlias("OSCACHE", "com.boidea.framework.core.orm.xibatis.sqlmap.engine.cache.oscache.OSCacheController");
