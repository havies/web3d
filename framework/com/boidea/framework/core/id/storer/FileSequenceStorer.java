package com.boidea.framework.core.id.storer;
...
import com.boidea.framework.core.id.test.Hello;
...
public class FileSequenceStorer implements SequenceStorer {
	...
	public static final String DEFAULT_FILE_PATH = "bf-id-sequence-store.properties";
	/**
	 * 文件路径，包含文件名，
	 */
