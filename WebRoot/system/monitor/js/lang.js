var lang = {
	...
	/**webapp-detail*/
	'OSMacOSXCount':['OSMacOSXCount', 'MacOSX平台访问次数'],
	'OSWindowsCount':['OSWindowsCount', 'Windows平台访问次数'],
	'OSLinuxCount':['OSLinuxCount', 'Linux平台访问次数'],
	'OSSymbianCount':['OSSymbianCount', 'Symbian平台访问次数'],
	'OSFreeBSDCount':['OSFreeBSDCount','FreeBSD平台访问次数'],
	'OSOpenBSDCount':['OSOpenBSDCount','OpenBSD平台访问次数'],
	'OSAndroidCount':['OSAndroidCount','Android平台访问次数'],
	'OSWindows98Count':['OSWindows98Count','Windows98平台访问次数'],
	'OSWindowsXPCount':['OSWindowsXPCount','WindowsXP平台访问次数'],
	'OSWindows2000Count':['OSWindows2000Count','Windows2000平台访问次数'],
	'OSWindowsVistaCount':['OSWindowsVistaCount','WindowsVista平台访问次数'],
	'OSWindows7Count':['OSWindows7Count','Windows7平台访问次数'],
	'OSWindows8Count':['OSWindows8Count','Windows8平台访问次数'],
	'OSAndroid15Count':['OSAndroid15Count','Android1.5设备访问次数'],
	'OSAndroid16Count':['OSAndroid16Count','Android1.6设备访问次数'],
	'OSAndroid20Count':['OSAndroid20Count','Android2.0设备访问次数'],
	'OSAndroid21Count':['OSAndroid21Count','Android2.1设备访问次数'],
	'OSAndroid22Count':['OSAndroid22Count','Android2.2设备访问次数'],
	'OSAndroid23Count':['OSAndroid23Count','Android2.3设备访问次数'],
	'OSAndroid30Count':['OSAndroid30Count','Android3.0设备访问次数'],
	'OSAndroid31Count':['OSAndroid31Count','Android3.1设备访问次数'],
	'OSAndroid32Count':['OSAndroid32Count','Android3.2设备访问次数'],
	'OSAndroid40Count':['OSAndroid40Count','Android4.0设备访问次数'],
	'OSAndroid41Count':['OSAndroid41Count','Android4.1设备访问次数'],
	'OSAndroid42Count':['OSAndroid42Count','Android4.2设备访问次数'],
	'OSAndroid43Count':['OSAndroid43Count','Android4.3设备访问次数'],
	'OSLinuxUbuntuCount':['OSLinuxUbuntuCount','Ubuntu平台访问次数'],
	'BrowserIECount':['BrowserIECount','IE浏览器访问次数'],
	'BrowserFirefoxCount':['BrowserFirefoxCount','Firefox浏览器访问次数'],
	'BrowserChromeCount':['BrowserChromeCount','Chrome浏览器访问次数'],
	'BrowserSafariCount':['BrowserSafariCount','Safari浏览器访问次数'],
	'BrowserOperaCount':['BrowserOperaCount','Opera浏览器访问次数'],
	'BrowserIE5Count':['BrowserIE5Count','IE5浏览器访问次数'],
	'BrowserIE6Count':['BrowserIE6Count','IE6浏览器访问次数'],
	'BrowserIE7Count':['BrowserIE7Count','IE7浏览器访问次数'],
	'BrowserIE8Count':['BrowserIE8Count','IE8浏览器访问次数'],
	'BrowserIE9Count':['BrowserIE9Count','IE9浏览器访问次数'],
	'BrowserIE10Count':['BrowserIE10Count','IE10浏览器访问次数'],
	'Browser360SECount':['Browser360SECount','360浏览器访问次数'],
	'DeviceAndroidCount':['DeviceAndroidCount','Android设备访问次数'],
	'DeviceIpadCount':['DeviceIpadCount','iPad设备访问次数'],
	'DeviceIphoneCount':['DeviceIphoneCount','iPhone设备访问次数'],
	'DeviceWindowsPhoneCount':['DeviceWindowsPhoneCount','WindowsPhone设备访问次数'],
	'SessionCount':['SessionCount','访问会话总数'],
	'BotCount':['BotCount','爬虫访问次数'],
	'BotBaiduCount':['BotBaiduCount','Baidu爬虫访问次数'],
	'BotYoudaoCount':['BotYoudaoCount','Youdao爬虫访问次数'],
	'BotGoogleCount':['BotGoogleCount','Google爬虫访问次数'],
	'BotMsnCount':['BotCount','爬虫访问次数'],
	'BotCount':['BotMsnCount','MSN爬虫访问次数'],
	'BotBingCount':['BotBingCount','Bing爬虫访问次数'],
	'BotSosoCount':['BotSosoCount','Soso爬虫访问次数'],
	'BotSogouCount':['BotSogouCount','Sogou爬虫访问次数'],
	'BotYahooCount':['BotYahooCount','Yahoo爬虫访问次数'],
	'ContextPath':['ContextPath','上下文根']
};
