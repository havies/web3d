package com.boidea.framework.core.mvc.xstruts.util;
...
import com.boidea.framework.core.mvc.xstruts.action.ActionServletWrapper;
...
import com.boidea.framework.core.mvc.xstruts.upload.MultipartRequestHandler;
import com.boidea.framework.core.mvc.xstruts.upload.MultipartRequestWrapper;
...
public class RequestUtils {
	...
	public static void populate(Object bean, String prefix, String suffix, HttpServletRequest request)
		...
		if ((contentType != null) && (contentType.startsWith("multipart/form-data"))
			...
			if (bean instanceof ActionForm) {
				...
				throw new ServletException("bean that's supposed to be "
						...
						+ "\"com.boidea.framework.core.mvc.xstruts.action.ActionForm\", but type " + "\""
		...
		while (names.hasMoreElements()) {
			...
			// such as 'com.boidea.framework.core.mvc.xstruts.action.CANCEL'
			if (!(stripped.startsWith("com.boidea.framework.core.mvc.xstruts."))) {
