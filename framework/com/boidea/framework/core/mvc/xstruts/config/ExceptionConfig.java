...
public class ExceptionConfig extends BaseConfig {
	 ...
	 */
	protected String handler = "com.boidea.framework.core.mvc.xstruts.action.ExceptionHandler";
	...
	public void inheritFrom(ExceptionConfig config) throws ClassNotFoundException, IllegalAccessException,
		...
		if (getHandler().equals("com.boidea.framework.core.mvc.xstruts.action.ExceptionHandler")) {
