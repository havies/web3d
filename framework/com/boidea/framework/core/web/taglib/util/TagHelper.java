package com.boidea.framework.core.web.taglib.util;
...
public class TagHelper {
	...
	public static String formatBodyContent(BodyContent pBodyContent){
		if(BFUtils.isEmpty(pBodyContent))
			return "";
	...
	public static String checkEmpty(String pString){
		return BFUtils.isEmpty(pString) ? TagConstant.Tpl_Out_Off : pString;
	}
}
