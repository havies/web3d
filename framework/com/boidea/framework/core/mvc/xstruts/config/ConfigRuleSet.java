package com.boidea.framework.core.mvc.xstruts.config;
...
public class ConfigRuleSet extends RuleSetBase {
	 ...
	 * <code>com.boidea.framework.core.mvc.xstruts.config.ModuleConfig</code> is pushed
	...
	public void addRuleInstances(Digester digester) {
		...
		digester.addSetNext("struts-config/action-mappings/action", "addActionConfig",
				"com.boidea.framework.core.mvc.xstruts.config.ActionConfig");
		...
		digester.addObjectCreate("struts-config/action-mappings/action/exception",
				"com.boidea.framework.core.mvc.xstruts.config.ExceptionConfig", "className");
		...
		digester.addSetNext("struts-config/action-mappings/action/exception", "addExceptionConfig",
				"com.boidea.framework.core.mvc.xstruts.config.ExceptionConfig");
		...
		digester.addSetNext("struts-config/action-mappings/action/forward", "addForwardConfig",
				"com.boidea.framework.core.mvc.xstruts.config.ForwardConfig");

		digester.addRule("struts-config/action-mappings/action/forward/set-property", new BaseConfigSetPropertyRule());

		digester.addObjectCreate("struts-config/controller", "com.boidea.framework.core.mvc.xstruts.config.ControllerConfig",
				"className");
		digester.addSetProperties("struts-config/controller");
		digester.addSetNext("struts-config/controller", "setControllerConfig",
				"com.boidea.framework.core.mvc.xstruts.config.ControllerConfig");
		...
		digester.addSetNext("struts-config/form-beans/form-bean", "addFormBeanConfig",
				"com.boidea.framework.core.mvc.xstruts.config.FormBeanConfig");

		digester.addObjectCreate("struts-config/form-beans/form-bean/form-property",
				"com.boidea.framework.core.mvc.xstruts.config.FormPropertyConfig", "className");
		...
		digester.addSetNext("struts-config/form-beans/form-bean/form-property", "addFormPropertyConfig",
				"com.boidea.framework.core.mvc.xstruts.config.FormPropertyConfig");
		...
		digester.addObjectCreate("struts-config/message-resources",
				"com.boidea.framework.core.mvc.xstruts.config.MessageResourcesConfig", "className");
		...
		digester.addSetNext("struts-config/message-resources", "addMessageResourcesConfig",
				"com.boidea.framework.core.mvc.xstruts.config.MessageResourcesConfig");

		digester.addRule("struts-config/message-resources/set-property", new BaseConfigSetPropertyRule());

		digester.addObjectCreate("struts-config/plug-in", "com.boidea.framework.core.mvc.xstruts.config.PlugInConfig");
		digester.addSetProperties("struts-config/plug-in");
		digester.addSetNext("struts-config/plug-in", "addPlugInConfig",
				"com.boidea.framework.core.mvc.xstruts.config.PlugInConfig");
 ...
 * <code>com.boidea.framework.core.mvc.xstruts.config.ModuleConfig</code>.
 * </p>
 */
 ...
 * be a <code>com.boidea.framework.core.mvc.xstruts.config.ModuleConfig</code>.
 * </p>
 */
