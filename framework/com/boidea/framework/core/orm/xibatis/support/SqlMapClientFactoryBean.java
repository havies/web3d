package com.boidea.framework.core.orm.xibatis.support;
...
import com.boidea.framework.core.orm.xibatis.sqlmap.client.SqlMapClient;
import com.boidea.framework.core.orm.xibatis.sqlmap.client.SqlMapClientBuilder;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.builder.xml.SqlMapConfigParser;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.builder.xml.SqlMapParser;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.builder.xml.XmlParserState;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.impl.ExtendedSqlMapClient;
import com.boidea.framework.core.orm.xibatis.sqlmap.engine.transaction.TransactionConfig;
	...
	public void setTransactionConfigClass(Class transactionConfigClass) {
		if (transactionConfigClass == null || !TransactionConfig.class.isAssignableFrom(transactionConfigClass)) {
			throw new IllegalArgumentException("Invalid transactionConfigClass: does not implement "
					+ "com.boidea.framework.core.orm.xibatis.sqlmap.engine.transaction.TransactionConfig");
		}
